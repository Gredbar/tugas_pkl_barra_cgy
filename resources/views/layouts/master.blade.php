...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" type="image/x-icon" href="{{ URL::to('assets/img/logoCircleFavicon.png') }}">
	<!-- Bootstrap CSS -->
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow flag-nav">
					<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
						<img src="{{ URL::to('assets/img/flags/ind.jpeg') }}" alt="" height="20"> <span>Indonesia</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right">
						<a href="javascript:void(0);" class="dropdown-item">
						<img src="{{ URL::to('assets/img/flags/ind.jpeg') }}" alt="" height="16"> Indonesia</a>
						<a href="javascript:void(0);" class="dropdown-item">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu notifications">
						...
						<div class="topnav-dropdown-footer"> <a href="activities.html">Lihat Semua Notifikasi</a> </div>
					</div>
				</li>
				<!-- /Notifications -->
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu notifications">
						<div class="topnav-dropdown-header">
							<span class="notification-title">Pesan</span>
							<a href="javascript:void(0)" class="clear-noti"> Bersihkan Semua </a>
						 </div>
						<div class="noti-content">
							<ul class="notification-list">
						...
						<div class="topnav-dropdown-footer"> <a href="chat.html">Lihat Semua Pesan</a> </div>
					</div>
				</li>
				<!-- /Message Notifications -->
				<li class="nav-item dropdown has-arrow main-drop">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="{{ route('profile_user') }}">Profile</a>
