            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="{{ route('home') }}" class="logo">
						<img src="{{ URL::to('assets/img/logoCircle.png') }}" width="40" height="40" alt="">
					</a>
                </div>
				<!-- /Logo -->
				...
				<ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow flag-nav">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="javascript:void(0);" class="dropdown-item"><img src="{{ URL::to('assets/img/flags/ind.jpeg') }}" alt="" height="16"> Indonesia</a>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu notifications">
							...
							<div class="topnav-dropdown-footer">
								<a href="chat.html">Lihat Semua Pesan</a>
							</div>
						</div>
					</li>
					<!-- /Message Notifications -->
