        ...
        <div class="content container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-3">
                                    <div> <span class="d-block">Pegawai Baru</span> </div>
                                ...
                                <p class="mb-0">Overall Pegawai 218</p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-3">
                                    <div> <span class="d-block">Pendapatan</span> </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="stats-list">
                                <div class="stats-info">
                                    <p>Hari Ini Keluar <strong>4 <small>/ 65</small></strong></p>
                                    <div class="progress">
                                ...
                                <div class="stats-info">
                                    <p>Project Selesai <strong>85 <small>/ 112</small></strong></p>
                                    <div class="progress">
                ...
                <div class="col-md-12 col-lg-6 col-xl-4 d-flex">
                    <div class="card flex-fill">
                        <div class="card-body">
                            ...
                            <div>
                                <p><i class="fa fa-dot-circle-o text-purple mr-2"></i>Tugas Selesai <span class="float-right">166</span></p>
                                <p><i class="fa fa-dot-circle-o text-warning mr-2"></i>Tugas Dalam Pengerjaan <span class="float-right">115</span></p>
                                <p><i class="fa fa-dot-circle-o text-success mr-2"></i>Tugas Ditangguhkan<span class="float-right">31</span></p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="leave-info-box">
                                ...
                                <div class="row align-items-center mt-3">
                                    <div class="col-6">
                                        <h6 class="mb-0">4 Sep 2019</h6> <span class="text-sm text-muted">Tanggal Keluar</span> </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex">
                    <div class="card card-table flex-fill">
                        <div class="card-header">
                            <h3 class="card-title mb-0">Pembayaran</h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                        ...
                        <div class="card-footer">
                            <a href="payments.html">Lihat Semua Pembayaran</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 d-flex">
                    <div class="card card-table flex-fill">
                        <div class="card-header">
                            <h3 class="card-title mb-0">Client</h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
